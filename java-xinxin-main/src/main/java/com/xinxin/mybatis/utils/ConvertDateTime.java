...
public class ConvertDateTime implements Serializable{
	...
	public static String getCurrentTimeForHHmmss(){
		DateTime date = new DateTime();
		String dateStr = date.toString(SERIAL_HOUR_MIN_SEC);
		return dateStr;
	}
	
	public static String getCurrentTimeForyyyyMMdd(){
		DateTime date = new DateTime();
		String dateStr = date.toString(SERIAL_ONLY_DATE);
		return dateStr;
	}
	...
	public static void main(String[] args) throws Exception {
		System.out.println(getCurrentTimeForyyyyMMdd());
