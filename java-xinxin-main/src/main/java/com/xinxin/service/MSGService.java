...
public class MSGService {
	...
	static final String accessKeyId = "LTAIB5BXxny1Rb8v";
	static final String accessKeySecret = "kG41oXcY2KGjV2QRNsYarApNrDA9d6";

	static final String SMS_01 = "SMS_107055188";
	static final String SMS_02 = "SMS_106955212";
	...
	public static SendSmsResponse sendSms() throws ClientException {
		...
		// 必填:待发送手机号
		request.setPhoneNumbers("17621777559");
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("卞晓峰");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode(SMS_01);
