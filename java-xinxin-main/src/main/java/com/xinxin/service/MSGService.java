...
//	
//	public static SendSmsResponse sendSms(String sms_code,String phone,Map<String, Object> Param) throws ClientException {
//		System.out.println(Constants.accessKeyId+":"+Constants.accessKeySecret);
//		// 可自助调整超时时间
...
//		// 必填:短信签名-可在短信控制台中找到
//		request.setSignName(Constants.SIGNATURE);
//		// 必填:短信模板-可在短信控制台中找到
...
//		// 必填-号码
//		request.setPhoneNumber("17621190543");
//		// 可选-流水号
...
//
//		// 发短信
//		System.out.println("短信发送开始的接口----------------");
//		Map<String, Object> paramsMap=new HashMap<String,Object>();
//		paramsMap.put("code", "123456");
//		paramsMap.put("name", "卞先生");
//		SendSmsResponse response = sendSms(Constants.SMS_REGISTER,"17621190543",paramsMap);
